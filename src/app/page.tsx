	...
	return (
		<>
			...
			<div className="flex flex-col flex-grow pt-16 md:pt-32 items-center">
				<div className={`grid grid-cols-1 gap-4 max-w-7xl mt-4 mx-2 md:mx-4 ${session ? 'md:grid-cols-2 lg:grid-cols-3' : ''}`}>
					{!session && (
						<Card
							title='マーケット計算'
							description='トーラムオンラインのマーケット最安価格の計算や税抜き価格の計算が出来ます。<br>
